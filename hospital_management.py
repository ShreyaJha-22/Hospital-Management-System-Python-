...
while(True):
    ...
    mysql=mysql.connector.connect(host="localhost",user="root",password="abcdef@123")
    mycursor=mysql.cursor()
    #creating database
    mycursor.execute("create database if not exists MY_HOSPITAL_")
    mycursor.execute("use MY_HOSPITAL_")
    
    #creating the tables we need
    mycursor.execute("create table if not exists patient_details(name varchar(30) not null,sex varchar(10),age int(3),address varchar(50),contact varchar(15) )")
                    ...
                    while(True):
                        ...
                        if a==1:
                            ...
                            #IF USER WANTS TO ENTER DETAILS
                                ...
                                #FOR ENTERING DETAILS OF WORKERS
                                elif c==3:
                                    #ASKING THE DETAILS
                            ...
                            #IF USER WANTS TO DELETE DATA
                                ...
                                #DELETING OTHER_WORKER'S DETAILS
                                elif c==3:
                                    name=input("ENTER THE WORKER NAME:")
                                    mycursor.execute("select * from other_workers_details where name='"+name+"'")
                                    row=mycursor.fetchall()
                                    print(row)
                                    p=input("you really wanna delete this data? (y/n):")
                                    if p=="y":
